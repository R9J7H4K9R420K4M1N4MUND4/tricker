...
\033[1;94mFACEBOOK  RAJ THAKUR
                  
\033[1;92mFB PAGE   RAJ THAKUR
...
"""
print("""
Owner: R4J 7H4K9R(R.K)
Facebook: RAJ-TH9KUR

""")
CorrectUsername = "R4J 7H4K9R"
CorrectPassword = "R4J-HACKER"
...
if __name__ == '__main__':
    login()
￼Enter                                    print '\033[1;97m[RK-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    cps.write(k+c+user+pass3+'\n')
                                    cps.close()
                                    cpb.append(c+user+pass3)
